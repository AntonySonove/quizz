...
class ControllerDescription
{
    ...
    public function setModelDescription(?ModelDescription $modelDescription): self
    {
        $this->modelDescription = $modelDescription;
        return $this;
    }

    public function getViewDescription(): ?ViewDescription
    {
        return $this->viewDescription;
    }
    public function setViewDescription(?ViewDescription $viewDescription): self
    {
        $this->viewDescription = $viewDescription;
        return $this;
    }
    ...
    public function setHeader(?ViewHeader $viewHeader): self
    {
        $this->viewHeader = $viewHeader;
        return $this;
    }
    ...
    public function setFooter(?ViewFooter $viewFooter): self
    {
        $this->viewFooter = $viewFooter;
        return $this;
    }
    ...
    {
        $script = "";
        $this->getFooter()->setScript($script);
    }
